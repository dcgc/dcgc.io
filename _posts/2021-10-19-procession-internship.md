...
## Pressure, Blackmail and "Cybersecurity Shortage" Myth

***"Simply put, there aren't enough qualified cybersecurity professionals."***

We are constantly hearing this all the time and interns are faced with this statement when undergoing the internship and when facing difficult situations or when the time to contest arises. Interns are pressured and blackmailed into thinking that they got a golden opportunity and that if they don't follow whatever necessary, they are dismissed. We don't have a workforce shortage problem, we never really did. What we have is a wrong placement and allocation problem. It's not about training people with Udemy online access and vendor in-person courses, it is about meaningfully onboarding, introducing and directing newbies into understanding and rationalizing what their role is and what it contributes to. If companies were to hire enough people to eliminate every security issue in their estate and corporation, they'd need to at least onboard both qualified people and new people, and we not only don't see this regularly, as we do not see an even hiring of both levels. Nevertheless, the answer is to have both trained personnel and technology that supports the security program into efficiently addressing most of the security issues and that prepares the organization to combat and respond against security incidents. Enterprises have treated information security as a manpower and triage problem. Find tools that help you get the most out of your available resources, don't piggyback and weight all your information security problems on top of people. Ok? 
